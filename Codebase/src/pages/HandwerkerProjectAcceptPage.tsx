...
export function HandwerkerProjectAcceptPage() {
  return (
    <DeviceShell className="hw-accept-screen" width={390}>
      <header className="hw-accept-topbar">
        <BrandLogoLink imgClassName="hw-accept-brand" src={assets.brandLogoAlt} />
        <img alt="" className="hw-accept-avatar" src={assets.hwCraftHeaderAvatar} />
      </header>
