/**
 * Rollrasen /gestaltung-extras — Frame 377-1666 (Figma)
 * Drei Extra-Karten: Pflegekonzept, Automatische Bewässerung, Saisonale Bepflanzung (REST Images API, PNG @2x)
 */
...
/** [envKey, defaultNodeId, outputFileName] — 32-315, 26-215, 32-316 laut Figma-Links */
const SPECS = [
  ['FIGMA_EXTRA_ROLLRASEN_PFLEGEKONZEPT_NODE_ID', '32:315', 'extras-frame377-rollrasen-pflegekonzept.png'],
  ['FIGMA_EXTRA_ROLLRASEN_BEWAESSERUNG_NODE_ID', '26:215', 'extras-frame377-rollrasen-bewaesserung.png'],
  ['FIGMA_EXTRA_ROLLRASEN_BEPFLANZUNG_NODE_ID', '32:316', 'extras-frame377-rollrasen-bepflanzung.png'],
];
...
async function main() {
  ...
  console.log('figma:pull-rollrasen-extras abgeschlossen.');
}
