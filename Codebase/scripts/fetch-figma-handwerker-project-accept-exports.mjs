/**
 * Handwerker /handwerker-projekt-annehmen — nur Miniatur (256-270).
 * Hintergrund: dasselbe Garten-Motiv wie Projektfreischaltung (project-frame377-release-backdrop.png,
 * Node 254-142) — nicht 451-314 exportieren: der ganze Screen enthält die Karte im Bitmap → Doppel-Karte.
 * Backdrop aktualisieren: npm run figma:pull-project-release
 */
...
const SPECS = [['FIGMA_HW_ACCEPT_THUMB_NODE_ID', '256:270', 'hw-frame256-projekt-annehmen-thumb.png']];
...
async function main() {
  ...
  console.log('figma:pull-handwerker-project-accept abgeschlossen.');
}
