/**
 * Paketpreise /paket-auswahl — Parent Frame 377-1676 (Figma)
 * Hero-Bild + gemeinsame Zahlungsmethoden-Leiste für beide Karten (REST Images API, PNG @2x)
 */
...
const SPECS = [
  ['FIGMA_PACKAGE_SELECTION_HERO_NODE_ID', '376:613', 'package-frame377-paket-auswahl-hero.png'],
  ['FIGMA_PACKAGE_PAYMENT_METHODS_STRIP_NODE_ID', '418:4', 'package-frame377-payment-methods.png'],
];
...
async function main() {
  ...
  console.log('figma:pull-package-selection abgeschlossen.');
}
