/**
 * Brunnen Materialauswahl /gestaltung-material — Frame 377-1660 (Figma)
 * Fünf Karten: Naturstein, Beton, Metall, Kunststoff, Überrasch mich (REST Images API, PNG @2x)
 */
...
/** [envKey, defaultNodeId, outputFileName] — Reihenfolge = Flow in customerFlow + Surprise */
const SPECS = [
  ['FIGMA_MATERIAL_BRUNNEN_NATURSTEIN_NODE_ID', '31:273', 'material-frame377-brunnen-naturstein.png'],
  ['FIGMA_MATERIAL_BRUNNEN_BETON_NODE_ID', '31:276', 'material-frame377-brunnen-beton.png'],
  ['FIGMA_MATERIAL_BRUNNEN_METALL_NODE_ID', '31:275', 'material-frame377-brunnen-metall.png'],
  ['FIGMA_MATERIAL_BRUNNEN_KUNSTSTOFF_NODE_ID', '31:274', 'material-frame377-brunnen-kunststoff.png'],
  ['FIGMA_MATERIAL_BRUNNEN_SURPRISE_NODE_ID', '31:277', 'material-frame377-brunnen-surprise.png'],
];
...
async function main() {
  ...
  console.log('figma:pull-brunnen-material abgeschlossen.');
}
