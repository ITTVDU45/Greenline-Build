/**
 * Rollrasen Materialauswahl /gestaltung-material — Frame 377-1655 (Figma „Frame 40“)
 * Drei Material-Karten (REST Images API, PNG @2x).
 * Häkchen: feature-frame377-selection-check.png (figma:pull-feature-selection, Node 23-13).
 */
...
/** [envKey, defaultNodeId, outputFileName] — 252/249/253 laut Figma-Links */
const SPECS = [
  ['FIGMA_MATERIAL_ROLLRASEN_NATURRASEN_NODE_ID', '30:252', 'material-frame377-rollrasen-naturrasen.png'],
  ['FIGMA_MATERIAL_ROLLRASEN_HYDRORASEN_NODE_ID', '30:249', 'material-frame377-rollrasen-hydrorasen.png'],
  ['FIGMA_MATERIAL_ROLLRASEN_KUNSTRASEN_NODE_ID', '30:253', 'material-frame377-rollrasen-kunstrasen.png'],
];
...
async function main() {
  ...
  console.log('figma:pull-rollrasen-material abgeschlossen.');
}
