/**
 * Gartenwege /gestaltung-extras — Frame 377-1672 (Figma „Frame 48“)
 * Drei Extra-Karten: Beleuchtung, Stufen, Einfassung (REST Images API, PNG @2x)
 */
...
/** [envKey, defaultNodeId, outputFileName] — Reihenfolge = featureConfigs.gartenweg.extras */
const SPECS = [
  ['FIGMA_EXTRA_GARTENWEG_BELEUCHTUNG_NODE_ID', '32:342', 'extras-frame377-gartenweg-beleuchtung.png'],
  ['FIGMA_EXTRA_GARTENWEG_STUFEN_NODE_ID', '32:341', 'extras-frame377-gartenweg-stufen.png'],
  ['FIGMA_EXTRA_GARTENWEG_EINFASSUNG_NODE_ID', '32:340', 'extras-frame377-gartenweg-einfassung.png'],
];
...
async function main() {
  ...
  console.log('figma:pull-gartenweg-extras abgeschlossen.');
}
