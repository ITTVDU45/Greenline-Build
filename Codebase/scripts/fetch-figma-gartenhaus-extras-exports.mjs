/**
 * Gartenhaus /gestaltung-extras — Frame 377-1668 (Figma „Frame 46“)
 * Vier Extra-Karten: Stromanschluss, Regenrinne, Überdachung, Beleuchtung (REST Images API, PNG @2x)
 */
...
/** [envKey, defaultNodeId, outputFileName] — 32-318 … 32-317 laut Figma-Links */
const SPECS = [
  ['FIGMA_EXTRA_GARTENHAUS_STROMANSCHLUSS_NODE_ID', '32:318', 'extras-frame377-gartenhaus-stromanschluss.png'],
  ['FIGMA_EXTRA_GARTENHAUS_REGENRINNE_NODE_ID', '32:319', 'extras-frame377-gartenhaus-regenrinne.png'],
  ['FIGMA_EXTRA_GARTENHAUS_UEBERDACHUNG_NODE_ID', '32:320', 'extras-frame377-gartenhaus-ueberdachung.png'],
  ['FIGMA_EXTRA_GARTENHAUS_BELEUCHTUNG_NODE_ID', '32:317', 'extras-frame377-gartenhaus-beleuchtung.png'],
];
...
async function main() {
  ...
  console.log('figma:pull-gartenhaus-extras abgeschlossen.');
}
