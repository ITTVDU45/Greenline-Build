/**
 * /gestaltung-extras — Terrassen-Karten (Frame 377-1664 in Figma)
 * REST Images API, PNG @2x
 */
...
const SPECS = [
  ['FIGMA_EXTRA_TERRASSE_BELEUCHTUNG_NODE_ID', '31:295', 'extras-frame377-terrasse-beleuchtung.png'],
  ['FIGMA_EXTRA_TERRASSE_STUFEN_NODE_ID', '31:296', 'extras-frame377-terrasse-stufen.png'],
  ['FIGMA_EXTRA_TERRASSE_UEBERDACHUNG_NODE_ID', '31:297', 'extras-frame377-terrasse-ueberdachung.png'],
  ['FIGMA_EXTRA_TERRASSE_FEUERSTELLE_NODE_ID', '31:298', 'extras-frame377-terrasse-feuerstelle.png'],
];
...
async function main() {
  ...
  console.log('figma:pull-terrasse-extras abgeschlossen.');
}
