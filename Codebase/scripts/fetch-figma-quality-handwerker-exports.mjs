/**
 * Qualitätsstufe /qualitaetsstufe — Frame 377-1680 (Figma, inkl. Frame-52-Knoten)
 * Drei Handwerker-Avatare für die Provider-Karten (REST Images API, PNG @2x)
 */
...
/** [envKey, defaultNodeId, outputFileName] — Reihenfolge = handwerkerOptions (Rebo Garden, Müller & Sohn, Rebo Gala) */
const SPECS = [
  ['FIGMA_QUALITY_HANDWERKER_REBO_GARDEN_NODE_ID', '16:668', 'quality-frame377-handwerker-rebo-garden.png'],
  ['FIGMA_QUALITY_HANDWERKER_MUELLER_SOHN_NODE_ID', '52:66', 'quality-frame377-handwerker-mueller-sohn.png'],
  ['FIGMA_QUALITY_HANDWERKER_REBO_GALA_NODE_ID', '52:65', 'quality-frame377-handwerker-rebo-gala.png'],
];
...
async function main() {
  ...
  console.log('figma:pull-quality-handwerker abgeschlossen.');
}
