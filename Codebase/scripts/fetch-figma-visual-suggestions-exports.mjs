/**
 * Gartenvorschau /visualisierung-vorschau — Frame 377-1678 (Figma)
 * Ausgangsbild + zwei KI-Varianten (REST Images API, PNG @2x)
 */
...
const SPECS = [
  ['FIGMA_VISUAL_VORHER_NODE_ID', '32:349', 'visual-frame377-vorher.png'],
  ['FIGMA_VISUAL_VARIANT1_NODE_ID', '32:351', 'visual-frame377-variant-1.png'],
  ['FIGMA_VISUAL_VARIANT2_NODE_ID', '32:353', 'visual-frame377-variant-2.png'],
];
...
async function main() {
  ...
  console.log('figma:pull-visual-suggestions abgeschlossen.');
}
