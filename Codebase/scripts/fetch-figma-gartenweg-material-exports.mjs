/**
 * Gartenwege Materialauswahl /gestaltung-material — Frame 377-1662 (Figma „Frame 43“)
 * Drei Material-Karten: Beton, Pflaster, Kies (REST Images API, PNG @2x).
 * „Überrasch mich“: weiter material-surprise-card.png (kein separater Figma-Link).
 */
...
/** [envKey, defaultNodeId, outputFileName] — Reihenfolge = customerFlow gartenweg.materials */
const SPECS = [
  ['FIGMA_MATERIAL_GARTENWEG_BETON_NODE_ID', '31:290', 'material-frame377-gartenweg-beton.png'],
  ['FIGMA_MATERIAL_GARTENWEG_PFLASTER_NODE_ID', '31:292', 'material-frame377-gartenweg-pflaster.png'],
  ['FIGMA_MATERIAL_GARTENWEG_KIES_NODE_ID', '31:291', 'material-frame377-gartenweg-kies.png'],
];
...
async function main() {
  ...
  console.log('figma:pull-gartenweg-material abgeschlossen.');
}
