/**
 * Projektfreischaltung /projektfreischaltung — Frame 377-1684 (Figma „Frame 54“)
 * Vollflächiger Hintergrund + Summary-Thumbnail (REST Images API, PNG @2x)
 */
...
/**
 * Hintergrund: 254-142 = großes Garten-Motiv (sichtbar als Screen-Bg).
 * 254-93 = PF_BG (flache Füllfarbe in Figma, Export ~wenige KB → wirkt wie grau ohne Foto).
 * Optional per FIGMA_PROJECT_RELEASE_BACKDROP_NODE_ID=254-93 nur die Figma-Fläche nutzen.
 */
const SPECS = [
  ['FIGMA_PROJECT_RELEASE_BACKDROP_NODE_ID', '254:142', 'project-frame377-release-backdrop.png'],
  ['FIGMA_PROJECT_RELEASE_SUMMARY_THUMB_NODE_ID', '254:144', 'project-frame377-release-summary-thumb.png'],
];
...
async function main() {
  ...
  console.log('figma:pull-project-release abgeschlossen.');
}
