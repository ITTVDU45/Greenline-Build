/**
 * Brunnen /gestaltung-extras — Frame 377-1670 (Figma)
 * Vier Extra-Karten: Beleuchtung, Wasserspiel, Stromanschluss, Filter/Technik (REST Images API, PNG @2x)
 */
...
/** [envKey, defaultNodeId, outputFileName] — Reihenfolge = featureConfigs.brunnen.extras */
const SPECS = [
  ['FIGMA_EXTRA_BRUNNEN_BELEUCHTUNG_NODE_ID', '32:321', 'extras-frame377-brunnen-beleuchtung.png'],
  ['FIGMA_EXTRA_BRUNNEN_WASSERSPIEL_NODE_ID', '32:323', 'extras-frame377-brunnen-wasserspiel.png'],
  ['FIGMA_EXTRA_BRUNNEN_STROMANSCHLUSS_NODE_ID', '32:322', 'extras-frame377-brunnen-stromanschluss.png'],
  ['FIGMA_EXTRA_BRUNNEN_FILTER_NODE_ID', '32:325', 'extras-frame377-brunnen-filter.png'],
];
...
async function main() {
  ...
  console.log('figma:pull-brunnen-extras abgeschlossen.');
}
