/**
 * Investitionsübersicht /investitionsuebersicht — Frame 377-1682 (Figma „Frame 53“)
 * Hero-Visual über der Kostenliste (REST Images API, PNG @2x)
 */
...
const SPECS = [
  ['FIGMA_INVESTMENT_OVERVIEW_HERO_NODE_ID', '301:47', 'investment-frame377-overview-hero.png'],
];
...
async function main() {
  ...
  console.log('figma:pull-investment-overview abgeschlossen.');
}
